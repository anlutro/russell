...
class Russell():
    ...
    def setup(self):
        ...
        write_file(os.path.join('pages', 'sample-page.md'), '            This is a sample page! Do with it whatever you like.')
        write_file(os.path.join('posts', 'sample-post.md'), '            This is a sample post! Do with it whatever you like.')
