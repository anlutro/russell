...
class SitemapGenerator:
	...
	def generate_sitemap(self):
		...
		tree.append(self.get_index_element(_schema_url(self.blog.root_url)))
	...
	def get_post_element(self, post):
		...
		elem.append(text_element('loc', _schema_url(post.url, self.https)))
	...
	def get_page_element(self, page):
		elem = etree.Element('url')
		elem.append(text_element('loc', _schema_url(page.url, self.https)))
		elem.append(text_element('changefreq', 'monthly'))
		return elem

	def get_tag_element(self, tag):
		elem = etree.Element('url')
		elem.append(text_element('loc', _schema_url(tag.url, self.https)))
		elem.append(text_element('changefreq', 'weekly'))
		return elem

	def get_index_element(self, url):
		elem = etree.Element('url')
		elem.append(text_element('loc', _schema_url(url, self.https)))
